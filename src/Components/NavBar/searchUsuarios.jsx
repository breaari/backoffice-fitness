  ...
  return (
    <div className='my-4'>
      <form onSubmit={handleSearch}>
        ...
        <label className='border-grismedio border rounded-md p-1 flex flex-row items-center w-[69%]'>
        ...
        <button type="submit" className='text-white px-2 py-1 bg-rojo font-bold rounded-md w-[20%]'>Buscar</button>
        <button className='w-[10%]'  onClick={toggleFilter}>
            <IoFilter className='text-[30px] mx-2' />
        </button>
        </div>
        {showFilter && (
          <div className='absolute top-[200px] right-[70px] bg-white p-4 border border-gray-300 rounded-md shadow-lg z-50'>
